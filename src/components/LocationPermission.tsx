...
const LocationPermission: React.FC<LocationPermissionProps> = ({
  ...
  // Jika permission sudah diberikan dan tidak required, tampilkan children
  if (permissionStatus === 'granted' && !required) {
    return <>{children}</>;
  }

  // Jika permission sudah diberikan dan required, tampilkan children
