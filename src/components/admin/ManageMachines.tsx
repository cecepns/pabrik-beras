    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Manajemen Mesin</h1>
            <p className="text-gray-600">Kelola data master mesin giling</p>
          </div>
                ...
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Kode Mesin</th>
                        ...
                        <tr key={machine.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="font-medium text-gray-900">{machine.kode_mesin}</span>
                            </div>
                          </td>
